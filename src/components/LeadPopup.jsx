          ...
          >
            ...
            <div className="bg-[#25D366] px-5 py-4 flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-white font-black text-sm leading-none">Contacto rápido</p>
            ...
            <div className="px-5 py-5">
              {product && (
                <div className="bg-cyan-50 border border-cyan-200 rounded-xl px-3 py-2 mb-4">
                  <p className="text-[10px] font-bold text-cyan-500 uppercase tracking-wider mb-0.5">Producto seleccionado</p>
              ...
              <AnimatePresence mode="wait">
                {done ? (
                  <motion.div key="done" initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                    ...
                    <p className="text-gray-900 font-bold text-sm mb-1">¡Listo!</p>
                    <p className="text-gray-500 text-xs">Abriendo WhatsApp...</p>
                  </motion.div>
                ) : (
                  <motion.form key="form" onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <div className="relative">
                      ...
                      >
                        <option value="" disabled>Tu sector / industria</option>
                    ...
                    <button type="submit" disabled={sending}
                      ...
                      {sending
                        ...
                        : <><span>Enviar y abrir WhatsApp</span><ArrowRight size={14} /></>
                      }
                    </button>
                  </motion.form>
                )}
