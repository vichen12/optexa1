...
export const PropuestaDeValor = () => {
  ...
  const PILLARS = [
    { icon: ICONS[0], tag: TAGS[0], title: t('value.pillars.p1title'), body: t('value.pillars.p1body'), stat: t('value.pillars.p1statValue'), statLabel: t('value.pillars.p1stat') },
    { icon: ICONS[1], tag: TAGS[1], title: t('value.pillars.p2title'), body: t('value.pillars.p2body'), stat: t('value.pillars.p2statValue'), statLabel: t('value.pillars.p2stat') },
    { icon: ICONS[2], tag: TAGS[2], title: t('value.pillars.p3title'), body: t('value.pillars.p3body'), stat: t('value.pillars.p3statValue'), statLabel: t('value.pillars.p3stat') },
  ];

  return (
    <section className="relative py-24 px-6 z-20 bg-white border-t border-gray-100">
      <div className="max-w-6xl mx-auto">
        {/* Definición canónica de la entidad — texto plano, extraíble por motores generativos */}
        <p className="text-gray-600 text-base leading-relaxed max-w-3xl mb-14 border-l-2 border-cyan-500 pl-4">
          {t('home.entityDef')}
        </p>
        <div className="mb-14">
