...
const NavLink = ({ href, children }) => (
  <li>
    <a
      href={href}
      className="group flex items-center gap-3 text-slate-300 hover:text-cyan-400 transition-all duration-300"
    >
...
export const Footer = () => {
  ...
  const companyGmailLink =
    "https://mail.google.com/mail/?view=cm&fs=1&to=stokkamza@gmail.com&su=Consulta%20desde%20la%20web&body=Hola!%20Vengo%20de%20la%20página,%20me%20interesaría%20una%20cotización.";
  const personalGmailLink =
    "https://mail.google.com/mail/?view=cm&fs=1&to=vichendallape@gmail.com&su=Propuesta%20Desarrollo%20Web&body=Hola%20Vincenzo!%20Me%20gustó%20tu%20página,%20¿me%20harías%20una%20igual?";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 mb-24 items-start">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-4">
                ...
                <span className="text-3xl font-black italic tracking-tighter text-white uppercase">
                  STOKKA<span className="text-cyan-500">_</span>
                </span>
              </div>

              <p className="text-slate-300 text-sm leading-relaxed max-w-sm font-medium italic border-l-2 border-cyan-500/30 pl-6">
                Ingeniería híbrida de alta precisión. Sincronizando el
                ecosistema industrial desde Mendoza para el mercado global.
              </p>

              <div className="space-y-4">
                <h4 className="text-[10px] font-black text-cyan-500/50 uppercase tracking-[0.3em]">
                  Canal_Ventas
                </h4>
                <a
                  href={companyGmailLink}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center gap-3 text-slate-200 hover:text-cyan-400 transition-colors"
                >
                  <div className="p-2 rounded-lg bg-white/5 border border-white/10 group-hover:border-cyan-500/50 transition-all">
                    <Mail size={16} className="text-cyan-400" />
                  </div>
                  <span className="font-mono text-sm tracking-tighter italic">
                    stokkamza@gmail.com
                  </span>
                </a>
              </div>
            ...
            <div className="flex gap-4">
              {[Linkedin, Instagram].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="p-4 rounded-2xl bg-white/5 border border-white/10 text-slate-300 hover:text-cyan-400 hover:border-cyan-500/50 transition-all backdrop-blur-md"
                >
                  <Icon size={20} />
                </a>
              ))}
          ...
          <div className="lg:col-span-3 space-y-8 lg:pl-12">
            <div className="flex items-center gap-3 text-cyan-400">
              <Cpu size={16} />
              <h4 className="text-xs font-mono font-black uppercase tracking-[0.4em]">
                Sistemas // ID
              </h4>
            </div>
          ...
          <div className="lg:col-span-5">
            <div className="p-8 rounded-[2.5rem] bg-cyan-950/10 backdrop-blur-2xl border border-cyan-500/20 relative overflow-hidden group shadow-2xl h-full flex flex-col justify-between italic text-white">
              ...
              <a
                href="#contacto"
                className="group/btn w-full flex items-center justify-center gap-4 px-6 py-5 bg-cyan-500 text-black font-black uppercase tracking-[0.2em] text-[11px] rounded-xl hover:bg-white transition-all duration-700 shadow-[0_10px_30px_rgba(34,211,238,0.2)] mt-auto"
              >
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-6 text-[10px] font-mono font-black text-slate-400 uppercase tracking-widest">
            <span className="flex items-center gap-2">
              <ShieldCheck size={14} className="text-cyan-900" />© {currentYear}{" "}
              STOKKA SOLUTIONS S.A.
            </span>
          </div>
          ...
          <div className="flex items-center gap-12">
            ...
            <div className="flex flex-col items-end gap-2 group cursor-pointer">
              ...
              <a
                href={personalGmailLink}
                target="_blank"
                rel="noopener noreferrer"
                className="text-[11px] font-bold text-slate-300 hover:text-white transition-colors flex items-center gap-2 font-mono"
              >
