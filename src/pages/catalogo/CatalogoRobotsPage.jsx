        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-12 py-16 lg:py-20">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: 'easeOut' }}>
            <nav className="flex items-center gap-2 text-xs text-gray-400 mb-5">
              ...
              <ChevronRight size={12} />
              <span className="text-cyan-500">Robots de manipulación</span>
            </nav>
            <p className="text-[10px] font-mono text-cyan-500 tracking-[0.5em] uppercase mb-4">Transelevadores · Shuttle · AMR · DELIE</p>
            <h1 className="text-gray-900 text-4xl md:text-5xl lg:text-6xl font-black italic uppercase leading-[1.05] tracking-tight mb-5">
              ...
              <span className="text-cyan-500">Transelevadores, shuttles y AMR</span>
            </h1>
      ...
      <section className="bg-white py-10 px-6 border-b border-gray-100">
        <div className="max-w-5xl mx-auto space-y-6">
          <div>
            ...
            <h2 className="text-2xl font-black text-gray-900 uppercase tracking-tighter">Transelevadores, robots shuttle, AMR, paletizadora automática y picking automatizado goods-to-person</h2>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              { value: '14', label: 'Modelos disponibles', sub: 'Gama más completa del mercado' },
              { value: '360 m/min', label: 'Velocidad máxima', sub: 'Transelevador MiniLoad DELIE' },
              { value: '±2 mm', label: 'Precisión', sub: 'Control de posición absoluta' },
              { value: '-25°C', label: 'Temp. mínima', sub: 'Cadena de frío certificada' },
            ].map(s => (
