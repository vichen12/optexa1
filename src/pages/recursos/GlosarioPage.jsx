...
const TERMINOS = [
  ...
  // — Vocabulario de búsqueda / conceptos de logística moderna —
  { term: 'Depósito inteligente', id: 'deposito-inteligente', cat: 'operaciones', def: 'Almacén que integra automatización, sensores y software de gestión para operar con mínima intervención humana. Combina sistemas de almacenamiento automático, robótica y datos en tiempo real para optimizar el flujo de mercadería, la densidad y la trazabilidad. Es la evolución del depósito tradicional hacia la logística 4.0.' },
  { term: 'Logística 4.0', id: 'logistica-4-0', cat: 'operaciones', def: 'Aplicación de las tecnologías de la Industria 4.0 —IoT, automatización, inteligencia artificial y análisis de datos— a la cadena de suministro y la operación de almacenes. Permite que depósitos, transelevadores, robots y software se comuniquen entre sí para una operación conectada, autónoma y autooptimizada.' },
  { term: 'Logística inteligente', id: 'logistica-inteligente', cat: 'operaciones', def: 'Gestión de la cadena de suministro basada en datos y automatización para tomar decisiones en tiempo real. Abarca desde el almacenamiento robotizado hasta la planificación de inventario predictiva, reduciendo costos, errores y tiempos en centros de distribución y depósitos automáticos.' },
  { term: 'Almacén 4.0', id: 'almacen-4-0', cat: 'operaciones', def: 'Almacén o centro de distribución que opera bajo el paradigma de la Industria 4.0: equipos automatizados interconectados, software de gestión (WMS/WCS) y datos en tiempo real. Sinónimo práctico de depósito inteligente y base de la intralogística moderna.' },
  { term: 'Smart warehouse', id: 'smart-warehouse', cat: 'operaciones', def: 'Término en inglés para "almacén inteligente". Designa un depósito altamente automatizado y digitalizado donde robots, transelevadores y software coordinan el almacenamiento y la preparación de pedidos con mínima intervención manual. Equivalente a depósito inteligente o almacén 4.0.' },
  { term: 'Dark warehouse', id: 'dark-warehouse', cat: 'operaciones', def: 'Almacén oscuro: depósito totalmente automatizado que opera sin iluminación ni personal en planta, porque la totalidad del manejo de mercadería la realizan robots y transelevadores. Representa el grado máximo de automatización logística y reduce drásticamente costos operativos y energéticos.' },
  { term: 'Goods to person', id: 'goods-to-person', cat: 'operaciones', def: 'Modelo de preparación de pedidos "mercancía a persona": el sistema lleva el producto hasta el operario en una estación fija, en lugar de que el operario camine hasta el producto. Multiplica la productividad de picking y es típico de los sistemas ASRS con shuttles y VLM.' },
  { term: 'Person to goods', id: 'person-to-goods', cat: 'operaciones', def: 'Modelo de preparación de pedidos "persona a mercancía": el operario se desplaza por el almacén hasta cada ubicación para recoger el producto. Es el método tradicional, más lento y con mayor recorrido, que la automatización goods-to-person busca reemplazar.' },
  { term: 'Cross docking', id: 'cross-docking', cat: 'operaciones', def: 'Estrategia logística en la que la mercadería que ingresa al centro de distribución se reexpide casi de inmediato hacia su destino, sin almacenamiento intermedio prolongado. Reduce inventario y tiempos; la automatización del flujo interno la hace mucho más eficiente.' },
  { term: 'Slotting', id: 'slotting', cat: 'operaciones', def: 'Asignación óptima de ubicaciones a los productos dentro del almacén según rotación, peso, tamaño y demanda. Un buen slotting reduce recorridos y tiempos de picking; los sistemas inteligentes lo recalculan dinámicamente con datos de la operación.' },
  { term: 'Throughput', id: 'throughput', cat: 'operaciones', def: 'Capacidad de procesamiento de un sistema logístico: cantidad de paletas, cajas o líneas que un almacén puede mover por hora. Es la métrica clave para dimensionar un proyecto de automatización y comparar tecnologías (transelevador vs. shuttle).' },
  { term: 'Densidad de almacenamiento', id: 'densidad-almacenamiento', cat: 'operaciones', def: 'Cantidad de mercadería que se puede almacenar por metro cuadrado o cúbico de un depósito. La automatización de alta densidad —ASRS, pallet shuttle, almacenamiento vertical— permite multiplicar la densidad respecto a una estantería convencional y aprovechar la altura de la nave.' },
  { term: 'Intralogística', id: 'intralogistica', cat: 'operaciones', def: 'Conjunto de procesos de flujo de materiales e información dentro de un almacén, depósito o planta: recepción, almacenamiento, preparación de pedidos y expedición. La intralogística automatizada es el corazón de la logística 4.0 y del almacén inteligente.' },
  { term: 'Supply chain', id: 'supply-chain', cat: 'operaciones', def: 'Cadena de suministro: red de proveedores, fabricantes, almacenes y transporte que lleva un producto desde el origen hasta el cliente final. La automatización de almacenes mejora un eslabón crítico de la supply chain: la velocidad y exactitud del fulfillment.' },
  { term: 'Fulfillment', id: 'fulfillment', cat: 'operaciones', def: 'Proceso completo de preparación y envío de un pedido desde el almacén hasta el cliente. En e-commerce, un fulfillment rápido y sin errores es decisivo; los depósitos automáticos con picking goods-to-person reducen drásticamente los tiempos de preparación.' },
  { term: 'Last mile', id: 'last-mile', cat: 'operaciones', def: 'Última milla: tramo final de la entrega, desde el centro de distribución hasta la puerta del cliente. Aunque ocurre fuera del almacén, un fulfillment automatizado y veloz mejora todo el proceso de última milla al acortar los tiempos de despacho.' },
  { term: 'Centro de distribución automatizado', id: 'centro-distribucion-automatizado', cat: 'operaciones', def: 'Centro de distribución (CD) que opera con sistemas automatizados de almacenamiento, transporte y preparación de pedidos. Reemplaza el manejo manual por transelevadores, shuttles, conveyors y software, logrando mayor throughput, densidad y exactitud que un CD tradicional.' },
  { term: 'Almacén oscuro', id: 'almacen-oscuro', cat: 'operaciones', def: 'Traducción de "dark warehouse": depósito que funciona sin personal ni luz en planta porque toda la operación está automatizada. Es el ideal de la automatización total de almacenes, con robots y transelevadores trabajando 24/7 sin intervención humana directa.' },
];
